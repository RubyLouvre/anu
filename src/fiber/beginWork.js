...
import { contextStack, componentStack, containerStack, emptyObject, updateQueue } from "../share";
...
function mergeStates(fiber, nextProps) {
    ...
    return instance.state = nextState;
}
...
function updateClassComponent(fiber) {
    let { type, stateNode: instance, isForced, props, stage, alternate } = fiber;
...
var stageIteration = {
    ...
    update(fiber, nextProps, nextContext, instance, isForced) {
        let args = [nextProps,  mergeStates(fiber,nextProps), nextContext];
