...
import './pages/demo/media/live-player/index';
import './pages/demo/media/live-pusher/index';
...
class Demo extends React.Component {
    config = {
        pages: [
            ...
            'pages/demo/media/live-player/index',
            'pages/demo/media/live-pusher/index'
        ],
        window: {
