            ...
            <div class="container">
                <div class="section">
                    ...
                    >
                        <div class="picker">
                            当前选择：
                            {this.state.array[this.state.index]}
                        </div>
                    </picker>
                </div>
                <div class="section">
                ...
                <div class="section">
                    ...
                    >
                        <div class="picker">当前选择: {this.state.time}</div>
                    </picker>
                </div>
                ...
                <div class="section">
                    ...
                    >
                        <div class="picker">当前选择: {this.state.date}</div>
                    </picker>
                </div>
                <div class="section">
                    ...
                    <picker
                        ...
                        custom-item={this.state.customItem}
                    >
                        <div class="picker">
                            当前选择：
                            {this.state.region[0]}，{this.state.region[1]}，
                            {this.state.region[2]}
                        </div>
                    </picker>
                </div>
