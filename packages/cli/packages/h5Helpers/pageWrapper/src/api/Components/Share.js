        ...
        <div className='share'>
          {
            shareTypes.map((share, index) => {
              return (
                <div className='share-item' key={index} onClick={this.handleShareClick.bind(this, share.key)}>
                  {share.icon}
                  <div>{share.name}</div>
                </div>
              );
