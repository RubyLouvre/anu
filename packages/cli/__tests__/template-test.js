const { transform,getTemplate, evalClass, getPropsStyle } = require('./utils/utils');
...
describe('Template', () => {
    ...
    describe('大小写', () => {
        test('单驼峰内置组件', () => {
            transform('return (<Dog>{this.state.list[this.state.index]}</Dog>)');
        ...
        test('双驼峰内置组件', () => {
            transform('return (<ScrollView>{this.state.list[this.state.index]}</ScrollView>)');
