...
function resetChildExpirationTime(fiber, renderTime) {
    if (renderTime !== Never && fiber.childExpirationTime === Never) {
    ...
    var _child = fiber.child;
    //遍历节点的兄弟，取得它们所有expirationTime，childUpdateExpirationTime，
    //然后计算得到最大的值作为childExpirationTime
    while (_child !== null) {
