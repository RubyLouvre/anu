...
CanvasContext.prototype.setShadow = function(offsetX = 0, offsetY = 0, blur = 0, color = 'black') {
  this.missions.push(() => {
...
CanvasContext.prototype.drawImage = function(imageResource, dx, dy, dWidth, dHeight, sx, sy, sWidth, sHeight) {
  this.missions.push(() => {
    this.ctx.drawImage(imageResource, dx, dy, dWidth, dHeight, sx, sy, sWidth, sHeight);
  });
};
