...
(function (global, factory) {
  ...
  function getComponentName(type) {
    ...
    if ((typeof type === 'undefined' ? 'undefined' : _typeof$1(type)) === 'object') {
      switch (type.$$typeof) {
  ...
  var hasNativePerformanceNow = (typeof performance === 'undefined' ? 'undefined' : _typeof$2(performance)) === 'object' && typeof performance.now === 'function';
  var localDate = Date;
      ...
      if (didUserCallbackTimeout) {
        while (firstCallbackNode !== null && !(enableSchedulerDebugging$1)) {
          ...
          if (firstCallbackNode.expirationTime <= currentTime) {
            do {
              flushFirstCallback();
            } while (firstCallbackNode !== null && firstCallbackNode.expirationTime <= currentTime && !(enableSchedulerDebugging$1));
            continue;
          }
          break;
        }
  ...
  function unstable_scheduleCallback(priorityLevel, callback, deprecated_options) {
    ...
    var expirationTime;
    if ((typeof deprecated_options === 'undefined' ? 'undefined' : _typeof$3(deprecated_options)) === 'object' && deprecated_options !== null && typeof deprecated_options.timeout === 'number') {
  ...
  function constructClassInstance(workInProgress, ctor, props, renderExpirationTime) {
    ...
    if ((typeof contextType === 'undefined' ? 'undefined' : _typeof$6(contextType)) === 'object' && contextType !== null) {
  ...
  function coerceRef(returnFiber, current$$1, element) {
    ...
    if (mixedRef !== null && typeof mixedRef !== 'function' && (typeof mixedRef === 'undefined' ? 'undefined' : _typeof$7(mixedRef)) !== 'object') {
      if (element._owner) {
  ...
  function ChildReconciler(shouldTrackSideEffects) {
    ...
    function createChild(returnFiber, newChild, expirationTime) {
      ...
      if ((typeof newChild === 'undefined' ? 'undefined' : _typeof$7(newChild)) === 'object' && newChild !== null) {
    ...
    function reconcileChildFibers(returnFiber, currentFirstChild, newChild, expirationTime) {
      var isUnkeyedTopLevelFragment = (typeof newChild === 'undefined' ? 'undefined' : _typeof$7(newChild)) === 'object' && newChild !== null && newChild.type === REACT_FRAGMENT_TYPE && newChild.key === null;
      if (isUnkeyedTopLevelFragment) {
        newChild = newChild.props.children;
      }
      var isObject = (typeof newChild === 'undefined' ? 'undefined' : _typeof$7(newChild)) === 'object' && newChild !== null;
      if (isObject) {
        switch (newChild.$$typeof) {
          case REACT_ELEMENT_TYPE:
  ...
  function commitNestedUnmounts(root) {
    ...
    while (true) {
      commitUnmount(node);
      if (node.child !== null && (
      !ReactDOMHostConfig.supportsMutation || node.tag !== HostPortal)) {
        node.child.return = node;
        node = node.child;
        continue;
      }
  ...
  function throwException(root, returnFiber, sourceFiber, value, renderExpirationTime) {
    ...
    if (value !== null && (typeof value === 'undefined' ? 'undefined' : _typeof$b(value)) === 'object' && typeof value.then === 'function') {
      var thenable = value;
  ...
  key, pendingProps, owner, mode, expirationTime) {
    ...
    if (typeof type === 'function') {
      ...
      getTag: switch (type) {
        ...
        default:
          {
            if ((typeof type === 'undefined' ? 'undefined' : _typeof$d(type)) === 'object' && type !== null) {
              switch (type.$$typeof) {
                case REACT_PROVIDER_TYPE:
            ...
            var info = '';
            invariant(false, 'Element type is invalid: expected a string (for built-in ' + 'components) or a class/function (for composite components) ' + 'but got: %s.%s', type == null ? type : typeof type === 'undefined' ? 'undefined' : _typeof$d(type), info);
          }
      }
    }
