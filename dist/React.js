/**
 * by 司徒正美 Copyright 2017-06-10T08:30:37.602Z
 */
...
(function (global, factory) {
	...
	var inBrowser = typeof window === 'object' && window.alert;
	...
	function diffProps(nextProps, lastProps, vnode, lastVnode, dom) {
	    ...
	    for (let name in lastProps) {
	        if (!nextProps.hasOwnProperty(name)) {
	            ...
	            propHooks[hookName2](dom, name, builtIdProperties[name] ? '' : false, lastProps);
	        }
	    }
	}
