...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return this.state.aaa === 'aaa' ? React.createElement(Inner, { className: this.state.aaa }) : React.createElement(Inner2, { className: this.state.aaa });
        }
    }]);
