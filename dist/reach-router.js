...
var pick = function pick(routes, uri) {
  ...
  for (var i = 0, l = ranked.length; i < l; i++) {
    ...
    var isRootRoute = routeSegments[0] === "";
    var params = {};
    ...
    for (; index < max; index++) {
      ...
      if (dynamicMatch && !isRootUri) {
        !!reservedNames.includes(dynamicMatch[1]) ? invariant_1$1(false, "<Router> dynamic segment \"" + dynamicMatch[1] + "\" is a reserved name. Please use a different name in path \"" + route.path + "\".") : void 0;
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    var _props = this.props,
        ...
        domProps = objectWithoutProperties(_props, ["location", "navigate", "basepath", "primary", "children", "component", "baseuri"]);
    ...
    if (match$$1) {
      ...
      var wrapperProps = primary ? _extends({ uri: uri, location: location }, domProps) : domProps;
...
var FocusHandler = function FocusHandler(_ref3) {
  var uri = _ref3.uri,
      ...
      domProps = objectWithoutProperties(_ref3, ["uri", "location"]);
  return React.createElement(
