...
describe("Redux", function() {
    ...
    it("Counter", () => {
        ...
        const render = () => {
            return ReactDOM.render(<Counter value={store.getState()} onIncrement={onIncrement} onDecrement={onDecrement} />, div);
        };
    ...
    it("TreeView", () => {
                ...
                return (
                    <div>
                        ...
                        {typeof parentId !== "undefined" && (
                            <a href="#" id={idArr.shift()} onClick={this.handleRemoveClick} className="remove" style={{ color: "lightgray", textDecoration: "none" }}>
                                ×
                            </a>
                        )}
                        <ul>
        ...
        ReactTestUtils.Simulate.click(ass[4]);
