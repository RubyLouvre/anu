...
describe('组件相关', function() {
	...
	it('测试两个相邻的数组的正确更新', function() {
		...
		class A extends React.Component {
			...
			render() {
				return this.state.f == '1'
					? [ <b>111</b>, <b>111</b>, <b>111</b> ]
					: [ <i>222</i>, <i>222</i>, <i>222</i> ];
			}
		}
		class B extends React.Component {
			constructor(a, b) {
			...
			render() {
				return this.state.f == '1'
					? [ <b>333</b>, <b>333</b>, <span>333</span> ]
					: [ <i>444</i>, <i>444</i>, <i>444</i> ];
			}
		}
		var s = ReactDOM.render(<App />, container);
		s.refs.bb.setState({ f: 0 });

		expect(container.textContent).toBe('111111111444444444');
	});
	it('移除组件', () => {
		var str = '';
