...
var eventSystem = {
    hackSetState: function(instance){
        ...
        if(!pendings.length){
            fiber.updateQueue.pendingCbs(function(){
                instance.wx.setData({
        ...
        console.log(instance, "hackSetState")
        if(instance.wx){
            instance.wx.setData({
                props: instance.props,
                state: instance.state,
...
var Renderer$1 = createRenderer({
    ...
    updateAttribute: function(fiber) {
       ...
       // var instanceId = props["data-instance-uid"];
        if (classId) {
            ...
            //  if (clazz && clazz) {
            var instance = fiber._owner; //clazz[instanceId];
            if(!instance.classUid){
                instance = get(instance)._owner
            }
            console.log("instance", instance.classUid)
            if (instance) {
                for (var name in props) {
                    if (onEvent.test(name) && isFn(props[name])) {
                        var cached =
                            instance.$$eventCached ||
                            (instance.$$eventCached = {});
    ...
    onUpdate: function(fiber) {
        ...
        if (
            fiber.props.isPageComponent &&
            currentPage.value.props.path != fiber.props.path
        ) {
...
function useComponent(props, children) {
    var is = props.is;
