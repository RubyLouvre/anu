...
(function umd(root, factory) {
    ...
    function getNodeTag(node) {
        return node.nodeName ? node.name.toLowerCase() : "";
    }
    ...
    var ReactInputSelection = {
        ...
        hasSelectionCapabilities: function (elem) {
            ...
            return nodeName && (nodeName === "input" && elem.type === "text" || nodeName === "textarea" ||
    ...
    var newOptions = {
        beforeRender: ReactInputSelection.getSelectionInformation,
        afterMount: ReactInputSelection.restoreSelection,
        afterUpdate: ReactInputSelection.restoreSelection,
    };
