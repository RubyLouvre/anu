(function umd(root, factory) {
    ...
    var ReactInputSelection = {
        ...
        restoreSelection: function (lastInformation) {
            ...
            if (priorFocusedElem && isInDocument(priorFocusedElem)) {
    ...
    var newOptions = {
        beforeRender: getSelectionInterface,
        afterMount: restoreSelectionInterface,
        afterUpdate: restoreSelectionInterface
    };
