 ...
 */
    function createDevToolsBridge() {
        ...
        var componentUpdated = function componentUpdated(component) {
            ...
            var instance = updateReactComponent(component.__current);
    ...
    function createReactDOMComponent(vnode, parentDom) {
      ...
      vnode === false
        ...
        return {
            ...
            _inDevTools: false,
            _renderedChildren: !isText && normalizeChildren(vnode.vchildren, dom),
 ...
 */
    function createReactCompositeComponent(vnode) {
        ...
        return {
            ...
            _renderedComponent: updateReactComponent(instance.__rendered, dom),
