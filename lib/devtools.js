(function(global, factory) {
    ...
    function normalizeChildren(vnode, dom) {
        if(vnode.vchildren){
            return vnode.vchildren.map(function(child) {
    ...
    function getKeyForVNode(vnode) {
        return vnode.stateNode || vnode._instance || vnode._hostNode;
    }
 ...
 */
    function createDevToolsBridge() {
        ...
        var componentAdded = function componentAdded(component) {
            var vnode = component.updater.vnode;
        ...
        var componentUpdated = function componentUpdated(component) {
            ...
            visitNonCompositeChildren(instanceMap.get(component), function(
                childInst
            ) {
                prevRenderedChildren.push(childInst);
            });

            var instance = updateReactComponent(component.updater.vnode);
 ...
 */
    function createReactCompositeComponent(vnode) {
        ...
        var instance = vnode.stateNode || vnode._instance;
        var dom = vnode._hostNode;
        return {
            ...
            _renderedComponent: updateReactComponent(instance.updater.vnode, dom),
