...
export function createElement(type, configs) {
    ...
    if (typeof type === 'function') {
        ...
        props.children = children
        var skipChildren = voidTags[type] || !children.length
    }

    return new Vnode(type, props, key, ref, vtype, skipProps, skipChildren)
}
...
function Vnode(type, props, key, ref, vtype, skipProps, skipChildren) {
    this.type = type
    this.props = props
    this.vtype = vtype
