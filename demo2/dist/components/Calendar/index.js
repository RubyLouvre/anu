        ...
        return h('view', { 'class': 'calendar' }, h('view', { 'class': 'e-head' }, this.state.week.map(function (item, idx) {
            ...
            return h('view', { key: idx }, h('view', {
                ...
                return h('view', { 'class': 'b-row', key: Row }, itemRow.map(function (item1, index1) {
                    return h('block', { key: index1 }, item1.isBlank ? h('view', { 'class': 'item' }) : h('view', { onTap: this.getDate.bind(this, item1.date), 'class': 'item item-a ' + (item1.isWeekend ? 'weekend' : ''), 'data-tap-uid': 'e8927', 'data-class-uid': 'c5450', 'data-key': idx + '-' + Row + '-' + index1 }, h('view', { 'class': 'day' }, item1.showDate)));
                }, this));
            }, this)));
        }, this)));
    },
...
Component(_ReactWX2.default.registerComponent(Calendar, 'Calendar'));
