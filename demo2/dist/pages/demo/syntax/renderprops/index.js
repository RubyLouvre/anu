...
P = _ReactWX2.default.toClass(P, _ReactWX2.default.Component, {
    render: function () {
        ...
        return h('view', null, h(_ReactWX2.default.useComponent, { render: state => {
                return h("view", null, "render props ", h(_ReactWX2.default.useComponent, { mouse: state, is: "Cursor" }));
            }, is: "MouseTracker",
            renderUid: 'render888' }));
    },
    classUid: 'c743'
