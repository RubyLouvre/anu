...
P = _ReactWX2.default.toClass(P, _ReactWX2.default.Component, {
    ...
    render: function () {
        ...
        return h('view', { 'class': 'container' }, h('view', { 'class': 'item-list' }, h('view', { 'class': 'item-list-hd' }, 'Icon'), h('view', { 'class': 'group' }, this.state.iconSize.map(function (item) {
            return h('icon', { type: 'success', size: item });
        }, this)), h('view', { 'class': 'group' }, this.state.iconType.map(function (item) {
