...
Unbatch = miniCreateClass(Unbatch, Component, {
	render: function render() {
...
var renderInstances = []
function toRenderProps(ret, parent) {
    var id = parent.props.renderUid;
    console.log('调用toRenderProps')
    renderInstances.forEach(function(el){
        console.log(el)
       if(el.renderUid === id){
           console.log("===")
           //console.log()
