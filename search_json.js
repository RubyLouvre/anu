window.ydoc_plugin_search_json = {
  "English": [
    {
      "title": "anu",
      "content": "\n\nanujs is a highly React16-compliant Mini React framework that is compatible with  React16.3.0, runs through the official 788 test cases, and supports 99% of the React ecosystem's components and UI libraries.Chinese users can join QQ group: 370262116As we all know, React has always had an oversized cymbal, so I re-implemented React on the basis of reading its source code, and only one third of React+ReactDOM after gz. For detailed data, see https://bundlephobia.com/, anu@1.4.3 is only 13.1 kb, react@16.4.1 is 2.3 kb, and react-dom@16.4.1 is 30.5 kb. If a router is used, react-router-dom@4.3.1 is 11 kb and reach@1.0.1 is 4.3 kb.",
      "url": "/en/index.html",
      "children": [
        {
          "title": "volume ratio",
    ...
    },
    {
      ...
      "children": [
        ...
        },
        {
          ...
          "content": "1.1.3 (2017.10.08)Abstracting an Update class that encapsulates all private data on a component instance2. Abstract an instantiateComponente for instantiating stateful and stateless components at the same time, no more mountStateless, updateStateless methods\n3. Fix the checkpoint point triggers two bugs onChange\n4. Add ReceiveComponent detection mechanism, if the context, props, then will not perform the receive, render, update hooks\n5. Modify the logic to detect empty objects\n6. Simplify the logic of the task scheduling system"
        },
        {
  ...
  "中文": [
    {
      "title": "anu",
      "content": "\n\nnpm install anujsanujs是一个高级兼容React16的迷你React 框架，它兼容React16.3.0的99%接口， 跑通了官方788个case， 支持React生态圈的99％的组件与UI库。中国用户可以加QQ交流学习群：  370262116众所周知， React 一直存在体积过大的诟， 因此我在熟读其源码的基础上，重新实现了React， gz后只有React+ReactDOM的三分之一。详细数据见 https://bundlephobia.com/, anu@1.4.3只有 13.1 kb， react@16.4.1为 2.3 kb, react-dom@16.4.1为 30.5 kb。如果使用路由器，react-router-dom@4.3.1为11 kb， reach@1.0.1为 4.3kb。",
      "url": "/ch/index.html",
      "children": [
        {
          "title": "体积比对",
